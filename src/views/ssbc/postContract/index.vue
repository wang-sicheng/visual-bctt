      ...
      <el-col :span="22" :offset="1" :xs="24">
        <el-form label-width="80px">
          ...
          <el-form-item label="合约名称">
            <el-input v-model="form.name" maxlength="64" show-word-limit placeholder="请输入长度不超过64位的合约名称，仅限大小写字母和数字"  oninput="this.value=this.value.replace(/[^[a-z0-9A-Z]/g,'')" @input="lengthRestriction" />
